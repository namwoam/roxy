# 0 "src/fsw-application.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/fsw-application.c"
# 21 "src/fsw-application.c"
# 1 "include/main.h" 1
# 21 "include/main.h"
...
# 27 "include/main.h" 2
# 22 "src/fsw-application.c" 2
# 57 "src/fsw-application.c"
int work_done;
...
long get_timestamp()
{
    struct timeval time;
    gettimeofday(&time, 
# 64 "src/fsw-application.c" 3 4
                       ((void *)0)
# 64 "src/fsw-application.c"
                           );
...
void TC_VHF_task()
{
    ...
    while (1)
    {
        roxy_event_receive(12);



        status = roxy_mqueue_receive(101, message_buffer, 256, 0);
        if (status == SUCCESS)
        {
...
void TM_VHF_task()
{
    ...
    while (1)
    {
        roxy_event_receive(13);



        sprintf(message_buffer, "Hello from TM: %d\n", tm);
        roxy_mqueue_send(100, message_buffer, 256);
        tm += 1;
    }
}
...
void DHS_VHF_task()
{
    ...
    {
        reset_gate_lock();
        roxy_event_receive(11);

        roxy_task_wait(10 * 1000 * 1000, 0);
...
void writer_task()
{
    ...
    while (1)
    {
        roxy_mqueue_receive(100, message_buffer, 256, 1);
        fptr = fopen("file-system-experiment.txt", "a");
        if (fptr == 
# 280 "src/fsw-application.c" 3 4
                   ((void *)0)
# 280 "src/fsw-application.c"
                       )
        {
...
void reader_task()
{
    ...
    while (1)
    {
        ...
        if (fptr == 
# 298 "src/fsw-application.c" 3 4
                   ((void *)0)
# 298 "src/fsw-application.c"
                       )
        {
            printf("Failed to open file, exiting\n");
            exit(0);
        ...
        fseek(fptr, 0L, 
# 303 "src/fsw-application.c" 3 4
                       2
# 303 "src/fsw-application.c"
                               );
        filesize = ftell(fptr);
        fclose(fptr);
        sprintf(message_buffer, "filesize:%d bytes\n", filesize);
        roxy_mqueue_send(101, message_buffer, 256);
        roxy_task_wait(1, 1);
    }
}
...
int main(int argc, char *argv[])
{
    ...
    roxy_mqueue_create(100, 512, 256);
    roxy_mqueue_flush(101);
    roxy_mqueue_create(101, 512, 256);
    roxy_task_create(100, 10, 
# 329 "src/fsw-application.c" 3 4
                                                     ((void *)0)
# 329 "src/fsw-application.c"
                                                         , SCIO_VHF_task, 
# 329 "src/fsw-application.c" 3 4
                                                                          ((void *)0)
# 329 "src/fsw-application.c"
...
# 330 "src/fsw-application.c" 3 4
                                                    ((void *)0)
# 330 "src/fsw-application.c"
                                                        , DHS_VHF_task, 
# 330 "src/fsw-application.c" 3 4
                                                                        ((void *)0)
# 330 "src/fsw-application.c"
...
# 331 "src/fsw-application.c" 3 4
                                                   ((void *)0)
# 331 "src/fsw-application.c"
                                                       , TC_VHF_task, 
# 331 "src/fsw-application.c" 3 4
                                                                      ((void *)0)
# 331 "src/fsw-application.c"
...
# 332 "src/fsw-application.c" 3 4
                                                   ((void *)0)
# 332 "src/fsw-application.c"
                                                       , TM_VHF_task, 
# 332 "src/fsw-application.c" 3 4
                                                                      ((void *)0)
# 332 "src/fsw-application.c"
...
# 333 "src/fsw-application.c" 3 4
                                                    ((void *)0)
# 333 "src/fsw-application.c"
                                                        , GCQ_VHF_task, 
# 333 "src/fsw-application.c" 3 4
                                                                        ((void *)0)
# 333 "src/fsw-application.c"
...
# 334 "src/fsw-application.c" 3 4
                                                    ((void *)0)
# 334 "src/fsw-application.c"
                                                        , MPQ_VHF_task, 
# 334 "src/fsw-application.c" 3 4
                                                                        ((void *)0)
# 334 "src/fsw-application.c"
...
# 336 "src/fsw-application.c" 3 4
                                                    ((void *)0)
# 336 "src/fsw-application.c"
                                                        , SYS_VHF_task, 
# 336 "src/fsw-application.c" 3 4
                                                                        ((void *)0)
# 336 "src/fsw-application.c"
...
# 338 "src/fsw-application.c" 3 4
                                                     ((void *)0)
# 338 "src/fsw-application.c"
                                                         , AOCS_VHF_task, 
# 338 "src/fsw-application.c" 3 4
                                                                          ((void *)0)
# 338 "src/fsw-application.c"
...
# 339 "src/fsw-application.c" 3 4
                                                   ((void *)0)
# 339 "src/fsw-application.c"
                                                       , PF_VHF_task, 
# 339 "src/fsw-application.c" 3 4
                                                                      ((void *)0)
# 339 "src/fsw-application.c"
...
# 340 "src/fsw-application.c" 3 4
                                                   ((void *)0)
# 340 "src/fsw-application.c"
                                                       , PL_VHF_task, 
# 340 "src/fsw-application.c" 3 4
                                                                      ((void *)0)
# 340 "src/fsw-application.c"
...
# 342 "src/fsw-application.c" 3 4
                                         ((void *)0)
# 342 "src/fsw-application.c"
                                             , timer_simulator, 
# 342 "src/fsw-application.c" 3 4
                                                                ((void *)0)
# 342 "src/fsw-application.c"
...
# 342 "src/fsw-application.c"
    ...
    roxy_task_create(111, 20, 
# 344 "src/fsw-application.c" 3 4
                                              ((void *)0)
# 344 "src/fsw-application.c"
                                                  , writer_task, 
# 344 "src/fsw-application.c" 3 4
                                                                 ((void *)0)
# 344 "src/fsw-application.c"
...
# 344 "src/fsw-application.c"
    ...
    roxy_task_create(112, 20, 
# 345 "src/fsw-application.c" 3 4
                                              ((void *)0)
# 345 "src/fsw-application.c"
                                                  , reader_task, 
# 345 "src/fsw-application.c" 3 4
                                                                 ((void *)0)
# 345 "src/fsw-application.c"
...
# 345 "src/fsw-application.c"
    ...
    roxy_task_start(102, 1);
    roxy_task_start(103, 1);
    roxy_task_start(104, 1);
    roxy_task_start(105, 1);

    roxy_task_start(106, 1);

    roxy_task_start(107, 1);
    roxy_task_start(108, 1);
    roxy_task_start(109, 1);

    roxy_task_start(110, 1);

    roxy_task_start(111, 1);
    roxy_task_start(112, 1);
    roxy_loop(110);
    roxy_clean();
