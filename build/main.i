...
# 122 "src/main.c"
    ...
    status = roxy_task_create(101, 11, 
# 127 "src/main.c" 3 4
                                                       ((void *)0)
# 127 "src/main.c"
                                                           , compute_task, 
...
# 147 "src/main.c"
    ...
    status = roxy_task_start(102, 2);
    if (status != SUCCESS)
    {
        return 0;
    }
    status = roxy_task_start(103, 2);
    if (status != SUCCESS)
    {
        return 0;
    }
    status = roxy_task_start(104, 1);
    if (status != SUCCESS)
    {
        return 0;
    }
